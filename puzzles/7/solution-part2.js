...
const arrayOfFileSizesAboveLimit = [];
const maxFileSize = 100000;
const totalDiskSpace = 70000000;
const requiredSpaceForUpdate = 30000000;
const spaceRequired = requiredSpaceForUpdate - (totalDiskSpace - fileTree.files);
...
function getFileSizesFromNode(object, key) {
    ...
    if(key === 'files') {
        ...
        if (object[key] >= spaceRequired ){
            arrayOfFileSizesAboveLimit.push(object[key]);
            console.log(' checking files');
            return false;
        } else {
            console.log(`${object[key]} is less than than ${spaceRequired}`, object[key] <= spaceRequired );
        }
    } else {
...
console.log('arrayOfFileSizesAboveLimit', arrayOfFileSizesAboveLimit);
let orderedList = arrayOfFileSizesAboveLimit.sort((a, b) => {
    if(a > b) {
        return 1;
    } else if (a < b) {
        return - 1;
...
// console.log('spaceRequired', spaceRequired);
// console.log('orderedList', orderedList);
// console.log('orderedList-lo', orderedList[0]);
// console.log('orderedList-hi', orderedList[orderedList.length - 1]);
console.log('finalAnswerp2', orderedList[0]);
